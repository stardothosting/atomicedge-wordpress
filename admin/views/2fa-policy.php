<?php
/**
 * AtomicEdge 2FA Policy Admin Settings
 *
 * Admin page for configuring 2FA enforcement policies.
 *
 * @package AtomicEdge
 * @since   1.8.0
 */
...
<div class="wrap atomicedge-2fa-policy-wrap">
	<h1>
		<span class="dashicons dashicons-shield-alt" style="font-size: 30px; width: 30px; height: 30px; vertical-align: middle; margin-right: 8px;"></span>
		<?php esc_html_e( 'Two-Factor Authentication Policy', 'atomic-edge-security' ); ?>
	</h1>
	...
	<div class="atomicedge-2fa-policy-container">
		...
		<div class="atomicedge-2fa-policy-form">
			<form method="post" action="">
				...
				<div class="atomicedge-setting-card">
					<h2><?php esc_html_e( 'Policy Status', 'atomic-edge-security' ); ?></h2>
					<p class="description">
				...
				<!-- Role Selection -->
				<div class="atomicedge-setting-card" id="role-selection" <?php echo ! $settings['enabled'] ? 'style="opacity:0.6;"' : ''; ?>>
					<h2><?php esc_html_e( 'Required Roles', 'atomic-edge-security' ); ?></h2>
					<p class="description">
				...
				<!-- Grace Period -->
				<div class="atomicedge-setting-card" id="grace-period" <?php echo ! $settings['enabled'] ? 'style="opacity:0.6;"' : ''; ?>>
					<h2><?php esc_html_e( 'Grace Period', 'atomic-edge-security' ); ?></h2>
					<p class="description">
		...
		<div class="atomicedge-2fa-policy-sidebar">
			<div class="atomicedge-setting-card atomicedge-compliance-card">
				<h2><?php esc_html_e( 'Compliance Status', 'atomic-edge-security' ); ?></h2>
...
jQuery(document).ready(function($) {
	// Toggle dependent sections based on policy enabled state.
	$('input[name="atomicedge_2fa_enabled"]').on('change', function() {
		const enabled = $(this).is(':checked');
		$('#role-selection, #grace-period').css('opacity', enabled ? 1 : 0.6);
	});
});
</script>
